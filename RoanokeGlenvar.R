...
#
A=SpatialPoints(USGS02054530$site)# Up gradient site TINKER CREEK
...
plot(USGS02054530$flowdata$dateTime,USGS02054530$flowdata$B, main="TINKER CREEK TO ROANOKE RIVER AT NIAGARA, VA")
...
#
plot(USGS02054530$flowdata$cms,USGS02054530$flowdata$depth_m, main="TINKER CREEK TO ROANOKE RIVER AT NIAGARA, VA")
...
USGS02054530$flowdata$newwave=
  USGS02054530$flowdata$cms *1.04 <
...
plot(USGS02054530$flowdata$dateTime,USGS02054530$flowdata$cms,
     type="l",xlim=c(USGS02054530$flowdata$dateTime[16900],
                     USGS02054530$flowdata$dateTime[16900+100]),
     main="Roanoke River at Glenvar-USGS02054530",xlab="Time",ylab="Q_cms",xaxt="n")

lines(USGS02054530$flowdata$outTime,USGS02054530$flowdata$cms,col=2)
axis(1, USGS02054530$flowdata$dateTime,
     format(USGS02054530$flowdata$dateTime, "%d/%b:%H:%M"))
legend("topright",                                 
...
#Homework plot
ggplot() +
  geom_line(aes(x=USGS02054530$flowdata$dateTime, y = USGS02054530$flowdata$cms, 
                colour="black")) +
  geom_line(aes(x=USGS02054530$flowdata$outTime, y = USGS02054530$flowdata$cms,
                colour="red")) +
  labs(x = 'Time', y = 'Flow (mm)')+ 
  xlim(USGS02054530$flowdata$dateTime[16900],USGS02054530$flowdata$dateTime[16900+200])+
  ...
  scale_color_identity(name = "Legend",
                       ...
                       guide = "legend")
#Answers
USGS02054530[["flowdata"]][["dt"]][16900]
USGS02054530[["flowdata"]][["ck"]][16900]
