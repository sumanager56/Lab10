...
#
A=SpatialPoints(USGS02055000$site)# Up gradient site TINKER CREEK
...
plot(USGS02055000$flowdata$dateTime,USGS02055000$flowdata$B, main="TINKER CREEK TO ROANOKE RIVER AT NIAGARA, VA")
...
#
plot(USGS02055000$flowdata$cms,USGS02055000$flowdata$depth_m, main="TINKER CREEK TO ROANOKE RIVER AT NIAGARA, VA")
...
plot(USGS02055000$flowdata$dateTime,USGS02055000$flowdata$cms,
     type="l",xlim=c(USGS02055000$flowdata$dateTime[4375],
                     USGS02055000$flowdata$dateTime[4375+75]),
     main="Roanoke River-USGS02055000",xlab="Time",ylab="Q_cms",xaxt="n")

lines(USGS02055000$flowdata$outTime,USGS02055000$flowdata$cms,col=2)
axis(1, USGS02055000$flowdata$dateTime,
     format(USGS02055000$flowdata$dateTime,"%d/%b:%H:%M"))
legend("topright",                                 
...
#Homework plot
ggplot() +
  geom_line(aes(x=USGS02055000$flowdata$dateTime, y = USGS02055000$flowdata$cms, 
                colour="black")) +
  geom_line(aes(x=USGS02055000$flowdata$outTime, y = USGS02055000$flowdata$cms,
                colour="red")) +
  labs(x = 'Time', y = 'Flow (mm)')+ 
  xlim(USGS02055000$flowdata$dateTime[16900],USGS02055000$flowdata$dateTime[16900+200])+
  ...
  scale_color_identity(name = "Legend",
                       ...
                       guide = "legend")
#Answers
USGS02055000[["flowdata"]][["dt"]][16900]
USGS02055000[["flowdata"]][["ck"]][16900]
